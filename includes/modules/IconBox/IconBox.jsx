...
export class IconBox extends Component {
    ...
    static css(props) {
        ...
        iconStyle = renderIconStyle(
            props,
            'icon',
            '%%order_class%% .dibx_icon_box-icon i.dibx_icon'
        );
    ...
    render_title = () => {
        ...
        if (title) {
            return <h2 className="dibx_icon_box-title">{title}</h2>;
        }
    };
    ...
    render_subtitle = () => {
        ...
        if (subtitle) {
            return <h4 className="dibx_icon_box-subtitle">{subtitle}</h4>;
        }
    };
    ...
    render_description = (description) => {
        if (description) {
            if (this.props.dynamic.description.value) {
                return (
                    <div className="dibx_icon_box-description">
                ...
                return (
                    <div
                        className="dibx_icon_box-description"
    ...
    renderContent = () => {
        if (
            ...
            return (
                <div className="dibx_icon_box-content">
                    {this.render_title()}
                    {this.render_subtitle()}
                    {this.render_description(this.props.description)}
                </div>
    ...
    renderButton() {
        ...
        if (props.use_button === 'on') {
            ...
            return (
                <div className="dibx_icon_box-btn-wrapper">
                    <a
                        className={`${utils.classnames(
                            customClass
                        )} dibx_btn dibx_icon_box-btn`}
                        href={buttonUrl}
                        target={target}
    ...
    render() {
        return (
            <div className="dibx_icon_box-container">
                <div className="dibx_icon_box-wrapper">
                    <div className="dibx_icon_box-icon">
                        <i className="dibx_icon">
