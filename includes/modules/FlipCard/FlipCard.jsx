...
class Flip_Card extends Component {
    ...
    static css(props) {
        ...
        const frontIconStyle = renderIconStyle(
            props,
            'front_icon',
            '%%order_class%% .dibx_flip_card-front-icon i.dibx_icon'
        );
        ...
        const backIconStyle = renderIconStyle(
            props,
            'back_icon',
            '%%order_class%% .dibx_flip_card-back-icon i.dibx_icon'
        );
        ...
        const responsiveCss = setResponsiveCSS(props, [
            ...
            {
                selector: '%%order_class%% .dibx_flip_card-front-icon',
            ...
            {
                selector: '%%order_class%% .dibx_flip_card-back-icon',
        ...
        const front_bg = dibxGetCustomBgCSS(
            props,
            'front',
            '%%order_class%% .dibx_flip_card-front',
            '',
            '#da4a4a'
        );

        // Back site background color
        const back_bg = dibxGetCustomBgCSS(
            props,
            'back',
            '%%order_class%% .dibx_flip_card-back',
            '',
            '#4f5ee4'
        );
    ...
    render_front_icon = () => {
        ...
        return (
            <div className="dibx_flip_card-icon dibx_flip_card-front-icon">
    ...
    render_front_img = () => {
        return (
            <div className="dibx_flip_card-front-img">
    ...
    render_front_media = () => {
        ...
        if (front_icon || front_img) {
            ...
            return <div className="dibx_flip_card-media">{media}</div>;
        }
    };
    ...
    render_front_title = () => {
        ...
        if (title) {
            return <h2 className="dibx_flip_card-front-title">{title}</h2>;
        }
    };
    ...
    render_front_subtitle = () => {
        ...
        if (subtitle) {
            return (
                <h4 className="dibx_flip_card-front-subtitle">{subtitle}</h4>
            );
        }
    };
    ...
    render_front_description = (front_description) => {
        if (front_description) {
            if (this.props.dynamic.front_description.value) {
                return (
                    <div className="dibx_flip_card-front-description">
                ...
                return (
                    <div
                        className="dibx_flip_card-front-description"
    ...
    renderFrontContent = () => {
        if (
            ...
            return (
                <div className="dibx_flip_card-content-wrapper">
                    {this.render_front_title()}
                    {this.render_front_subtitle()}
    ...
    render_back_icon = () => {
        ...
        return (
            <div className="dibx_flip_card-icon dibx_flip_card-back-icon">
                <i className="dibx_icon">{Icon}</i>
            </div>
        );
    };
    ...
    render_back_img = () => {
        return (
            <div className="dibx_flip_card-back-img">
    ...
    render_back_title = () => {
        ...
        if (title) {
            return <h2 className="dibx_flip_card-back-title">{title}</h2>;
        }
    };
    ...
    render_back_subtitle = () => {
        ...
        if (subtitle) {
            return <h4 className="dibx_flip_card-back-subtitle">{subtitle}</h4>;
        }
    };
    ...
    render_back_description = (back_description) => {
        if (back_description) {
            if (this.props.dynamic.back_description.value) {
                return (
                    <div className="dibx_flip_card-back-description">
                ...
                return (
                    <div
                        className="dibx_flip_card-back-description"
    ...
    renderButton() {
        ...
        if (props.use_button === 'on') {
            ...
            return (
                <div className="dibx_flip_card-btn-wrapper">
                    <a
    ...
    render() {
        ...
        if (use_3d_animation === 'on') {
            classes.push('dibx_flip_card--3d');
        }
        ...
        return (
            <div className={`dibx_flip_card ${classes.join(' ')}`}>
                <div className="dibx_flip_card-inner">
                    <div className="dibx_flip_card-front dibx_flip_card-container">
                        <div className="dibx_flip_card-content">
                            {this.render_front_media()}
                            {this.renderFrontContent()}
                        </div>
                    </div>
                    <div className="dibx_flip_card-back dibx_flip_card-container">
                        <div className="dibx_flip_card-content">
